...
touch /home/ChiefCommander/nearest_10.txt
chmod u+rwx,g+rwx /home/ChiefCommander/nearest_10.txt
chown aryanw /home/ChiefCommander/nearest_10.txt
cat myTemp.txt | sort -n -k 3,3 | head -n 10 | awk '{ print $1 " " $2 }' >> /home/ChiefCommander/nearest_10.txt
